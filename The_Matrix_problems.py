...
from The_Vector_Space_problems import vec_sum
...
def lin_comb_mat_vec_mult(M, v):
    ...
    return vec_sum([Vec(M.D[0], {md0: M.f[md0, vd] * v.f[vd] for md0 in M.D[0]}) for vd in v.D], M.D[0])
